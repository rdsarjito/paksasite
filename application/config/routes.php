...
$route['uang_kas'] = 'uang_kas';
$route['detail_bulan_pembayaran'] = 'detail_bulan_pembayaran';
$route['riwayat_pengeluaran'] = 'riwayat_pengeluaran';
$route['coming_soon'] = 'coming_soon';
